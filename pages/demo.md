...
<div class="pt-12">
  <span @click="$slidev.nav.next" class="px-2 py-1 rounded cursor-pointer" hover="bg-white bg-opacity-10">
    Press Space for next page1 <carbon:arrow-right class="inline"/>
  </span>
</div>
...
<v-drag-arrow pos="681,195,-327,-48" two-way op70 />
